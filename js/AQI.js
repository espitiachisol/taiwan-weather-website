...
function getData() {
  ...
  req.open(
    "get",
    "https://data.epa.gov.tw/api/v1/aqx_p_432?offset=0&limit=100&api_key=2a19f687-37b3-41a5-bf4d-6828ee27bbb2"
  );
